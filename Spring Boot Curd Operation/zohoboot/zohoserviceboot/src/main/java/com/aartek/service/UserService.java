...
public class UserService {
	...
	{
		logger.warn("Inside UserService : updateProduct");
		logger.info(prod.getProdid());
		logger.info(prod.getProdname());
		userrepository.updateProduct(prod);
	}
	
	public Product deleteProduct(Integer id)
	{
		System.out.println("User Service : deleteProduct");
		Product prod=userrepository.deleteProduct(id);
		return prod;
	}
}
