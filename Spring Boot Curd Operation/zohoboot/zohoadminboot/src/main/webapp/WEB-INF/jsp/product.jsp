...
<form:form action="productAction" method="post" modelAttribute="product">
		<pre>
...
<table id="example" border="1" align="centre">
	...
	<c:forEach items="${prodList}" var="prod">
		<tr>
			...
			<td><a href="<c:url value='/prodedit-${prod.prodid}'/>">Edit</a></</td>
			<td><a href="<c:url value='/proddelete-${prod.prodid}'/>">Delete</a></</td>
		</tr>
	</c:forEach>
	</c:otherwise>
	</c:choose>
